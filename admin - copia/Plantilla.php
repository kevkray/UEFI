      ...
      <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="agregarProgramaAcademico.php">Programa académico</a></li>
          ...
          <li class="sub-menu">
            ...
            <!-- Opciones dentro del botón -->
            <ul class="sub">
              <li><a class="" href="programasAcademicos.php">Programa académico</a></li>
              <li><a class="" href="convenios.php">Convenio</a></li>
              <li><a class="" href="inscripciones.php">Inscripciones</a></li>
            </ul>
            <!-- /Opciones dentro del botón -->
          </li>
          <!-- /Botón Consultar -->
